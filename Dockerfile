...
#RUN dnf install php php-cli php-curl php-mysqlnd php-gd php-opcache php-zip php-intl httpd-devel httpd httpd-tools -y
RUN dnf install php php-* httpd-devel httpd httpd-tools -y
